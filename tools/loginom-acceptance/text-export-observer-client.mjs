...
if(purpose==='user-v1-component'){const {installAccountProbe}=await import('./text-export-account-probe.mjs');installAccountProbe({Client,Server,CallToolRequestSchema,runDirectory,stateDirectory,overallDeadline});}
