...
assert a.READONLY_PRODUCER == 'collapse_native_sessions_v1' and a.admission(None)['ready'] is True
print(json.dumps(dict(status='TOOLING_PASS',runtime=a.RUNTIME,ready=True,model_started=False)))
