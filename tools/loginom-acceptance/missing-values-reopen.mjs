...
if(!plan||(!diagnostic&&Object.entries(report.checks).some(([k,v])=>k!=='independent_reopen_present'&&!v.passed))||!plan.package_path.startsWith('/test-4/packages/')||plan.runtime_revision!=='0f835b823b54e2eefc3fd720fbfdf73606bcab70e9f9a805487efa6399a97b18')throw Error('Verified working phase required before independent reopen');
