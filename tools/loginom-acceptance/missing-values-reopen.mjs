...
if(!plan||(!diagnostic&&Object.entries(report.checks).some(([k,v])=>k!=='independent_reopen_present'&&!v.passed))||!plan.package_path.startsWith('/test-4/packages/')||plan.runtime_revision!=='68e8e7a7cac00b8afa45ac8f5b60bdcfa8832efc86ed34445f2bd4f1baf10e62')throw Error('Verified working phase required before independent reopen');
