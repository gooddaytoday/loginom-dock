...
if(!plan||(!diagnostic&&Object.entries(report.checks).some(([k,v])=>k!=='independent_reopen_present'&&!v.passed))||!plan.package_path.startsWith('/test-4/packages/')||plan.runtime_revision!=='4111dfed253d484003d5fb48c09006ec70e3057d0a9cfacd8f025b189884fc31')throw Error('Verified working phase required before independent reopen');
