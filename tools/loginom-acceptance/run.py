...
def execute(args):
    ...
    probe=grouping_upload_probe if goal_id=='grouping-node-complete' else upload_probe
    if goal_id in ('file-upload-probe','file-upload-verify','data-pipeline','import-roundtrip','calculator-roundtrip','node-import-roundtrip','node-apply-complete','calculator-node-complete','grouping-node-complete'):
    ...
    try:
        ...
        if args.goal in ('node-apply-complete','calculator-node-complete','grouping-node-complete'):
