...
def validate_inputs(args):
    ...
    if getattr(args,'goal',None) in ('join-node-complete','join-review-complete'):
...
def execute(args):
    ...
    join_probe=join_review_upload_probe if goal_id=="join-review-complete" else join_upload_probe
    join_fixture_dir="fixtures/join-review" if goal_id=="join-review-complete" else "fixtures/join"
    ...
    if goal_id in ('join-node-complete','join-review-complete'):
    ...
    try:
        ...
        if args.goal in ('join-review-complete','join-node-complete','node-apply-complete','calculator-node-complete','grouping-node-complete','sales-sorting-complete','reform-node-complete','filter-node-complete'):
