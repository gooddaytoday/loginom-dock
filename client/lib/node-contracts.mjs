...
export const NODE_TYPES = freeze(Object.fromEntries(definitions.map(([type, title, icon, inputs, outputs, additional, modes, help]) => [type, {
  type, title, palette_group: type === 'preprocessing.data_recovery' ? 'Предобработка' : type === 'imports.text' ? 'Импорт' : 'Трансформация', icon_class: 'bg-vendor-icon-' + icon, contract_revision: NODE_CONTRACT_REVISION,
