...
const uiActionTool = { name: 'dock_ui_action',
  description: 'Perform one bounded UI gesture on a fresh ref from dock_workspace_observe: click, double_click, fill, press, drag or scroll. action uses verb, e.g. {verb:"click",ref:"<observed ui-ref>"}, {verb:"drag",source_ref:"<observed ui-ref>",target_ref:"<observed ui-ref>"} or {verb:"scroll",ref:"<observed ui-ref>",delta_y:300}. Scroll requires allowed_actions including scroll and targets only its observed scroll owner; delta_y is a nonzero integer within -1000..1000. Read the new observation after scrolling; old refs/pages are invalid. Use for settings, execution, inspection and repairs outside the ready-made actions. No JavaScript or selectors. A successful gesture is not proof of task completion: inspect its result. operation_id is a NEW unique UI request ID; for a pending partial action, recovery_operation_id is that ORIGINAL pending operation ID.',
