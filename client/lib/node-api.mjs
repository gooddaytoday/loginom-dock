...
export const nodeApplyInputSchema=object({
 ...
 target:object({kind:choice('new','existing'),type:choice('research.duplicates','imports.text','transform.calculator','transform.group_data','transform.sorting','transform.reform_columns','transform.filter_data','transform.join_data','transform.union_data'),label:text(200),ref,
 ...
 mode:choice('mark','delimited','expression','aggregate','keys','scalar','conditions','inner','left','append_all'),parameters:object({input_fields:duplicatesParametersSchema.properties.input_fields,output_fields:duplicatesParametersSchema.properties.output_fields,
