...
export const nodeApplyInputSchema=object({
 ...
 target:object({kind:choice('new','existing'),type:choice('imports.text','transform.calculator','transform.group_data','transform.sorting','transform.reform_columns','transform.filter_data','transform.join_data','transform.union_data','transform.collapse_columns'),label:text(200),ref,
 ...
 mode:choice('delimited','expression','aggregate','keys','scalar','conditions','inner','left','append_all','unpivot'),parameters:object({
  ...
  information:collapseParametersSchema.properties.information,transposed:collapseParametersSchema.properties.transposed,ignore_empty:boolean,
