...
Построй граф и параметры по заданию. Пять обработчиков: текстовый импорт,
Калькулятор, Группировка, Сортировка, Параметры полей; профиль ограничен Loginom 7.4.2.
