...
export async function ensureGroupingOutputSources(channel,initial,verifyFetch=verifyGroupingSourceFetch){
 ...
 verifyFetch(before,after.node_mapping);return after;
}
