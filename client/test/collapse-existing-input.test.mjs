...
const snapshot=()=>({verified:true,complete:true,cleanup_complete:true,mutation_calls:0,document_id:'d',workflow_id:'w',node_id:'n',build:'7.4.2',binding:{node:'n',input:'p',link:'l',source:'s',source_port:'sp',status:1,state:0,input_status:1,source_status:1,locked:false},active:true,references_acquired:13,references_released:13,native_schema_bytes:[7,8,9],fields:[{index:0,id:0,name:'EntityId',source_name:'Id',type:4},{index:1,id:1,name:'Value',source_name:'V',type:5}]});
...
for(const [name,edit] of [
 ...
 ['cleanup',s=>s.references_released--],['missing schema bytes',s=>s.native_schema_bytes=[]],['mutation',s=>s.mutation_calls=1],
