...
async function fixture() {
  ...
  const events=[];
  const rt=runtime(page,{artifactStore:store,onRecord:async record=>events.push(record),execute:async code=>{
...
test('verification hashes downloaded bytes once and records proof separately from pending upload',async()=>{
