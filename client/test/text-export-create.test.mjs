...
function fixture(mode={}){
 ...
 const task={deadline:Date.now()+10000,request:{document_id:'doc',workflow_ref:{workflow_id:'wf',prefix,tab_tid:tabTid}},types:{'exports.text':{title:'Текстовый файл'}},effect:{id:'effect',kind:'create',before,parameters:{type:'exports.text',position:{x:mode.drop?5000:600,y:380}}}};
