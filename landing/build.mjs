...
for (const file of ['styles.css', 'hero.css', 'hero.mjs', 'flow-interaction.mjs', 'app.js', 'instructions.mjs', 'robots.txt', 'sitemap.xml']) await cp(join(root, file), join(out, file));
