...
Дополнение на 9 сентября 2026, 18:08 МСК: три замечания к `b24310ea` исправлены.
[Проверки исправлений и ограничения](03-review-followup.md): client 1083 PASS/1 SKIP,
Python 400 PASS, финальный Hermes 45/45 independent PASS. Настройка/Execute 1000 полей
проверены отдельно; полное чтение и persistence схемы такого размера не приняты.
Приёмка ниже относится к исходной реализации и сохранена как история.
