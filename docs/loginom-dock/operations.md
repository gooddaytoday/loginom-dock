...
с сервером 3 сентября 2026 года; перед изменениями повторить read-only проверки.
...
Текущий релиз — `/opt/loginom-dock/releases/20260902-stage1-db787b90`, исходный
commit `70411dfe7317a5dd222c075a55e1158a05dbd465`.
...
| `loginom-dock-caddy-1` | `loginom-dock:landing-70411dfe` |
...
`sha256:fe9b84a23ea952a60b824d84766d5cac120297bbe0ab0746f4b080aaa55de313`.
Другие два вспомогательных контейнера сохранены на прежних проверенных образах.
...
На 3 сентября текущая установленная среда этой машины —
`~/.loginom-dock/releases/0.1.0-dev.0-038fefe35353`. Это прежняя проверенная установка,
а не чистая установка опубликованного `0.1.0-rc.1`. Не обновлять её молча ради
...
Релизные доказательства — `.dock/releases/v0.1.0-rc.1/`, приёмка Hermes —
...
Лендинг уже входит в Caddy image и существующий backup. Автоматическая отправка
копий во внешнее хранилище отложена пользователем. Полная копия однажды была
скачана на Mac, но это не включённое внешнее расписание. Не считать `healthy` в
