## Linux: сохранённый объём и границы проверки — 16 сентября 2026
...
Общие исправления импорта, дат и группировки остаются незакоммиченными.
...
исправления. Она не является приёмкой текущего HEAD; перед выпуском нужно
проверить выбранный состав клиента. Пять ОС проверялись контейнерными smoke,
