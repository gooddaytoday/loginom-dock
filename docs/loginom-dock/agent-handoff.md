...
Актуализировано 3 сентября 2026 года после публикации отдельного лендинга.
...
- Опубликован предварительный клиент `0.1.0-rc.1` для macOS Apple Silicon и Linux x64.
  Тег `loginom-dock@0.1.0-rc.1` закреплён на
  `7ff258f26c3375eee2924b798a905f754683be2c`.
...
Дефект состава тестов следующего выпуска исправлен при подготовке Windows-кандидата:
...
Опубликованный `0.1.0-rc.1` собран до добавления этого теста и не затронут.
